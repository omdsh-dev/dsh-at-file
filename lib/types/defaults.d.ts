...
export declare function workspaceIgnoreFilesFor(entries: readonly WorkspaceIgnoreFiles[], workspace: string): string[];
/** Effective file-name filters for one workspace: global rules plus local additions. */
export declare function effectiveIgnoreFiles(settings: AtFileSettings, workspace: string): string[];
